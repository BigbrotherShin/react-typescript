...
// 디스패치를 위한 타입 (Dispatch 함수에 대한 타입을 리액트에서 불러올 수 있음), 액션들의 타입을 Dispatch 의 Generics로 설정
...
// 다른 컴포넌트에서 useContext 를 사용하는 대신,
...
export function useSampleState() {
  ...
  if (!state) throw new Error('Cannot find SampleProvider'); // 유효하지 않을 땐(state가 null인 경우) 에러를 발생
